...
- Advertise peer review activities as potentialy advantageous when applying for a job in the academia. Employers would gain insight how well an aplicant performs in critical thinking and writing. 
...
Maybe breaking the peer review proces into smaller milestones (reviewing just a paragraph or a section) would increase the response from users / academics. These "milestones" and their potential reviewers could be automatically selected basing on the area of experties of the reviewer (statistics in the methods section would be offered to a competent person with statistical background, and the "surgical procedure" section of the very same paper - to a practicing surgeon who has poor understanding of statistical methods).

# My comments

From the discussion, it is clear that most people are unhappy with the current system but no one can give real solutions. Systems like stackoverflow are not fitted for peer review. But on the other hand the reputation system proposed on stackoverflow, which is very complex and accurate (it's hard to game it) could probably be used for validating researcher's expertise levels (at least his expertise in the peer review abilities). 
